            ...
            <v-card style="border-radius:0px;padding-top:10px;background-color:#fcfcfc">
              <v-card-title fill-width>
                <v-layout column>
                  ...
                  <v-flex class="text-xs-center">
                    <v-btn outline style="border-radius:0px;background-color:#f4b061;"type="submit" @click.prevent = "join">JOIN</v-btn>
                  </v-flex>
                </v-layout>
              </v-card-title>
              <v-card-title class="text-xs-center">
                <v-layout row justify-space-around>
                  ...
                  <v-btn flat style="border-radius:2px;"type="submit" @click.prevent = "instagram">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                  ...
                  <v-btn flat style="border-radius:2px;"type="submit" @click.prevent = "facebook">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
export default {
  ...
  computed: {
    binding () {
      ...
      if (this.$vuetify.breakpoint.smAndUp) binding.xs6 = false
...
main {
  background: url("/static/results.jpg") no-repeat fixed center center;
